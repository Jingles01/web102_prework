...
const displayStr = `A total of ${raisedCard} has been raised for ${numUnfunded} games. Currently, 
    ${numUnfunded} ${numUnfunded === 1 ? 'game remains' : 'games remain'} unfunded. We need your 
    support to reach our funding goals!`;

// create a new DOM element containing the template string and append it to the description container
const descriptionUnfunded = document.createElement('p');
descriptionUnfunded.innerHTML = displayStr;
descriptionContainer.appendChild(descriptionUnfunded);
